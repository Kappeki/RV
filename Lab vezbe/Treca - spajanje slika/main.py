...
def findhomography_and_concat(slika1, slika2):
    ...
    kp1, ds1 = detector.detectAndCompute(slika1, None) # kljucne tacke i deskriptori
    kp2, ds2 = detector.detectAndCompute(slika2, None) # kljucne tacke i deskriptori
    ...
    MIN_MATCH_COUNT = 22    # homografska matrica
